...
def replicate(path):
    """
    Fit replication. Will take the results of a fit and re-run it with the same
    seed, and compare the results of the fit.

    Arguments
    =========
    path - str
        Path to a pickle file generated by main()
    ...
    Notes
    =====
    Both the `theta` and `y0` values are compared. If any of these arrays are
    not equal, an exception will be raised.
    """
